...
//    add room
    class func addRoom(title:String,place:String,price:String,description:String,image:UIImage,Authorization:HTTPHeaders,complation : @escaping (_ error:Error? ,_ success : Bool)-> Void){
